...
const HelpPage: React.FC = () => (
  <div style={{width: '100%', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
    ...
    <ul>
      ...
      <li><strong>Drag & Drop:</strong> You can reorder task cards on the main page by dragging them. You can also reorder steps within each card by dragging the step handle. This works on both the main page and in Settings when editing default steps.</li>
