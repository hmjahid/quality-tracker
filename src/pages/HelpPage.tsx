...
const HelpPage: React.FC = () => (
  <div style={{width: '100%', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
    ...
    <ul>
      <li><strong>Dashboard (Main Page):</strong> Add, edit, or delete work type cards. Each card represents a project or work category. Click the card title to edit it. Set an optional deadline using the date picker.</li>
      ...
      <li><strong>Default Steps:</strong> In Settings, configure default mandatory steps for each work type. New cards of that type will use your custom steps.</li>
      ...
      <li><strong>About:</strong> See app and developer info, and open source license, in the About page.</li>
    </ul>
